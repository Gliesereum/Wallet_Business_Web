    ...
    return (
      ...
      >
        <div className="profile-main-info-form-upload">
          ...
          >
            <div>
              {avatarImageUrl ? <img src={avatarImageUrl} alt="" />
                : <span>{getFirstLetterName(firstName, lastName)}</span>}
          ...
          >
            <div>
              <img src={coverImageUrl || defaultCoverImg} alt="" />
